  ...
  <footer className="bg-dark text-cream py-16">
    <div className="max-w-[1240px] mx-auto px-6 lg:px-12">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              <Link key={l.href} href={l.href} className="text-[13px] text-cream/60 hover:text-primary transition-colors">{l.label}</Link>
            ))}
          </div>
        </div>
        <div>
          ...
          <div className="flex flex-col gap-2">
            <Link href="/#cases" className="text-[13px] text-cream/60 hover:text-primary transition-colors">성과</Link>
            <Link href="/#contact" className="text-[13px] text-cream/60 hover:text-primary transition-colors">연락</Link>
          </div>
        </div>
        <div>
      ...
      <div className="border-t border-cream/10 pt-5 flex justify-between items-center">
        <p className="text-[11px] text-cream/30">&copy; 2026 PIXELPAGE</p>
