...
export default async function LandingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <LandingClient project={project} isStaff={isStaff} analyses={analyses} integ={integ ? { ga4_property_id: integ.ga4_property_id, clarity_project_id: integ.clarity_project_id, hasClarityToken: !!integ.clarity_api_token } : null} ga4Configured={!!process.env.GA4_SERVICE_ACCOUNT_JSON} />;
}
