    ...
    <div className="bg-[#08080d] text-white min-h-screen selection:bg-sky-500/30">
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-[16px] text-sky-300/60 font-mono font-bold">{s.tag}</span>
                </div>
                <h3 className="text-[18px] md:text-[19px] font-bold mb-3 tracking-[-0.02em] leading-[1.3]">{s.title}</h3>
                <p className="text-[16.5px] text-white/60 leading-[1.75] whitespace-pre-line">{s.body}</p>
              </div>
            ))}
          </div>
      ...
      <footer className="py-12 bg-[#06060a] border-t border-white/[0.05]">
        <div className="max-w-[1120px] mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-[16px] text-white/35 text-center">
