  ...
  <div>
    ...
    <section className="relative min-h-screen flex items-center pt-32 pb-20 bg-[#0a0f1e] overflow-hidden">
      <div className="relative z-10 max-w-[1240px] mx-auto w-full px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <p className="text-[12px] tracking-[0.1em] uppercase text-white/50 mb-6">03 · Search Engine Optimization</p>
            ...
            <p className="text-[18px] text-white/50 leading-[1.85] max-w-[480px] mb-8">
              광고는 돈을 써서 보여주는 것이고, SEO는 <strong className="text-white font-medium">돈을 쓰지 않아도 찾아오게 만드는 것</strong>입니다.
            </p>
          ...
          <div className="hidden lg:flex justify-center">
            <img src={illustSeo.src} alt="검색엔진 최적화" className="w-[300px] animate-float" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-28 lg:py-36" style={{ background: "#ffffff" }}>
      <div className="max-w-[1240px] mx-auto px-6 lg:px-12">
        <Reveal>
          <p className="text-[12px] tracking-[0.1em] uppercase text-muted-foreground mb-6">왜 SEO인가요?</p>
        ...
        <Reveal>
          <div className="max-w-[720px] space-y-6">
            <p className="text-[18px] text-muted-foreground leading-[1.85]">
              퍼포먼스 광고는 즉각적인 효과가 있지만, 광고비를 쓰는 동안만 유입이 발생합니다. SEO는 다릅니다. 한 번 만든 콘텐츠가 검색 상위에 노출되면, <strong className="text-foreground font-medium">광고비 없이도 매일 새로운 잠재 고객이 찾아옵니다.</strong>
            </p>
            <p className="text-[18px] text-muted-foreground leading-[1.85]">
    ...
    <section className="py-28 lg:py-36" style={{ background: "#fbfbfb" }}>
      <div className="max-w-[1240px] mx-auto px-6 lg:px-12">
        <Reveal>
          <p className="text-[12px] tracking-[0.1em] uppercase text-muted-foreground mb-6">Platforms</p>
        ...
        <Reveal className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-[#e5e7eb] p-8 border-l-4 border-l-blue-500 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              <span className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center text-[16px] font-bold text-blue-500">N</span>
              <div>
                <span className="block text-[14px] font-medium text-foreground">네이버 SEO</span>
                <span className="text-[10px] font-bold tracking-[0.08em] uppercase text-blue-500">운영 중</span>
              </div>
            </div>
            <p className="text-[15px] text-muted-foreground leading-[1.85] mb-6">
            ...
            {["네이버 블로그 SEO", "스마트스토어 · 플레이스 최적화", "지식iN · 카페 마케팅", "월간 키워드 리서치"].map(f => (
              <p key={f} className="text-[13px] text-muted-foreground pl-3 py-1.5 border-l-2 border-blue-500/30 mb-1">{f}</p>
            ))}
          </div>
          <div className="rounded-2xl border border-[#e5e7eb] p-8 border-l-4 border-l-muted opacity-60 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
    ...
    <section className="py-28 lg:py-36 bg-[#0a0f1e] text-center">
      <div className="max-w-[1240px] mx-auto px-6 lg:px-12">
        <Reveal>
          <h2 className="break-keep text-[clamp(32px,4.5vw,56px)] font-bold text-white leading-[1.12] tracking-[-0.03em] mb-4">네이버 SEO는 지금 바로 시작할 수 있습니다.</h2>
          <p className="text-[18px] text-white/50 mb-8 max-w-[440px] mx-auto leading-[1.85]">무료 상담에서 현재 검색 노출 현황을 진단하고, 키워드 전략을 함께 설계합니다.</p>
